...
set encoding utf8 
set output 'Q3straddledelta.png'

set title 'Straddle Delta vs Stock Price' font 'Arial-Bold,12' 
set xrange [60:140]
set yrange [-2:2]
set xlabel 'Stock Price' font 'Arial-Bold,12'
set ylabel 'Straddle Delta' font 'Arial-Bold,12'
...
plot 'Q3straddle.txt' using 1:2 w l ls 1 title '1 month',\
		 'Q3straddle.txt' using 1:5 w l ls 2 title '1 year'
