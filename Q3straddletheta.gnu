...
set encoding utf8 
set output 'Q3straddletheta.png'

set title 'Straddle Theta vs Stock Price' font 'Arial-Bold,12' 
set xrange [60:140]
set yrange [-60:10]
set xlabel 'Stock Price' font 'Arial-Bold,12'
set ylabel 'Straddle Theta' font 'Arial-Bold,12'
...
plot 'Q3straddle.txt' using 1:4 w l ls 1 title '1 month',\
		 'Q3straddle.txt' using 1:7 w l ls 2 title '1 year'
